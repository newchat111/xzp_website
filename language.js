const translations = {
    en: {
        ...
        "home.projects.report.title": "AI-Powered Medical Report Generation System",
    ...
    zh: {
        ...
        "home.publications.mediqa.title": "SUAT-BMI at MEDIQA EVAL 2026：将多语言模型集成作为评审器，用于医疗回复自动评分",
        "home.publications.mediqa.venue": "ACL Anthology Clinical Workshop",
        "home.projects.title": "项目",
        "home.projects.report.title": "AI 医疗报告生成系统",
        "home.projects.report.tags": "医疗 AI • 分布式系统 • 大语言模型应用",
        "home.projects.report.summary": "一个面向生产环境的临床文档服务，将大语言模型与检索增强生成结合，用于生成基于证据的医疗报告。",
